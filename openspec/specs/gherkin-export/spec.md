...
- **WHEN** a user in a session editor clicks the Export button
...
- **WHEN** a user in a session editor clicks the Export MD button
...
- **WHEN** a data table block is present and the user exports as TXT
...
> **Tests:** [`e2e/data-table.spec.ts`](../../../e2e/data-table.spec.ts)
- **WHEN** a data table block is present and the user exports as MD
