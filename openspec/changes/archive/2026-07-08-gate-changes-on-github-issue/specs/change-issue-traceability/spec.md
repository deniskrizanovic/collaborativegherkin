...
> **Tests:** [`scripts/lint-issue-link.test.ts`](../../../../scripts/lint-issue-link.test.ts) — accepts a proposal with a `## GitHub Issue` URL for an open issue
...
> **Tests:** [`scripts/lint-issue-link.test.ts`](../../../../scripts/lint-issue-link.test.ts) — flags a proposal with no `## GitHub Issue` section
...
> **Tests:** [`scripts/lint-issue-link.test.ts`](../../../../scripts/lint-issue-link.test.ts) — flags a proposal whose issue resolves to state `closed`
...
> **Tests:** [`scripts/lint-issue-link.test.ts`](../../../../scripts/lint-issue-link.test.ts) — flags a proposal whose issue lookup returns not-found
...
> **Tests:** [`scripts/lint-issue-link.test.ts`](../../../../scripts/lint-issue-link.test.ts) — fails closed when the issue lookup errors
...
> **Tests:** [`scripts/lint-issue-link.test.ts`](../../../../scripts/lint-issue-link.test.ts) — ignores changes under `archive/`
